...
void main(){
  ...
  group('cacheFirstTimer', () {
    test('should call [SharedPreferences] to catch the data', () async{
   when(()=> prefs.setBool(any(), any())).thenAnswer((_) async => true,);

   await localDataSource.catchFirstTimer();
   ...
   verifyNoMoreInteractions(prefs);
    ...
    test('should through a [CacheException] when there is an error caching a data', () async{
      when(()=> prefs.setBool(any(), any())).thenThrow(Exception());

      final methodCall = localDataSource.catchFirstTimer;
